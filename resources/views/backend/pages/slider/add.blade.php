                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label for="nama">Title<span class="text-danger">*</span></label>
                            <input type="text" name="title" id="nama" class="form-control">
                        </div>
                        @error('title')
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label for="e">Subtitle<span class="text-danger">*</span></label>
                            <input type="text" name="subtitle" id="e" class="form-control">
                        </div>
                        @error('subtitle')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
